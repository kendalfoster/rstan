...
install_StanHeaders <- function(rstan_branch = "develop", 
  ...
  git2r::clone("http://github.com/kendalfoster/rstan", path_rstan, branch = rstan_branch)
  git2r::clone("http://github.com/kendalfoster/stan",
               file.path(path_rstan, "StanHeaders", "inst", "include", "upstream"), 
               branch = library_branch)
  git2r::clone("http://github.com/kendalfoster/math",
